...
cupsdAddPrinter(const char *name)	/* I - Name of printer */
{
  ...
  */
  ...
  {
    printf("Unable to allocate memory for printer - %s",
                    strerror(errno));
    return (NULL);
  }
  ...
  */
  ...
  printf("cupsdAddPrinter: Adding %s to Printers", p->name);
...
cupsdLoadAllPrinters(void)
{
  ...
  */
 printf("LoadallPrinters ServerRoot =[%s],ServerBin=[%s]\n",ServerRoot,ServerBin);
...
cupsdSaveAllPrinters(void)
{
  ...
  printf("Into cupsdSaveAllPrinters Function\n");
 /*
    ...
    cupsd_printer_t **printer)		/* O - Printer pointer */
{
  ...
  printf("cupsdValidateDest(uri=\"%s\", dtype=%p, printer=%p)\n", uri,
                dtype, printer);
  ...
  */
  ...
  printf("cupsdValidateDest separateuri uri[%s],scheme[%s],username[%s],hostname[%s],port[%d],resource[%s]\n",uri, scheme,username,hostname,port, resource);
...
cupsdWritePrintcap(void)
{
  ...
  printf("Into cupsdWritePrintcap Function \n");
#ifdef __sgi
 /*
  ...
  */
  ...
  printf("Generating printcap %s...", Printcap);
  ...
  */
  ...
  {
      printf("open printcap file %s failed\n",Printcap);
      return;
  }
