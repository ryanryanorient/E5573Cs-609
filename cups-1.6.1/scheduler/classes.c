    ...
    const char *name)			/* I - Class to check */
{
  ...
  printf("Into Function cupsdFindAvailablePrinter\n");
  ...
  */
  ...
  if ((c = cupsdFindClass(name)) == NULL)
  {
    ...
    printf("no class,return NULL\n");
    return (NULL);
  }

  if (c->num_printers == 0)
  {
      printf("num_printers == 0,return NULL\n");
       return (NULL);
  }
 /*
  ...
  */
  ...
  for (i = c->last_printer + 1; ; i ++)
  {
    ...
    {
      c->last_printer = i;
      printf("find printer in class,return printer\n");
      return (c->printers[i]);
    }
  ...
  printf("Leave Function cupsdFindAvailablePrinter,return NULL\n");
  return (NULL);
}
...
cupsdLoadAllClasses(void)
{
  ...
  */
  printf("LoadAllClass from %s/classes.conf\n",ServerRoot);
...
cupsdSaveAllClasses(void)
{
  ...
  printf("Into cupsdSaveAllClasses Function\n");
 /*
