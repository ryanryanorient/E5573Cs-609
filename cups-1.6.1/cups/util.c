...
cupsPrintFile(const char    *name,	/* I - Destination name */
	      ...
	      cups_option_t *options)	/* I - Options */
{
  printf(("cupsPrintFile(name=\"%s\", filename=\"%s\", "
...
cupsPrintFile2(
    ...
    cups_option_t *options)		/* I - Options */
{
  printf(("cupsPrintFile2(http=%p, name=\"%s\", filename=\"%s\", "
                "title=\"%s\", num_options=%d, options=%p)",
...
cupsPrintFiles(
    ...
    cups_option_t *options)		/* I - Options */
{
  printf(("cupsPrintFiles(name=\"%s\", num_files=%d, "
    ...
    cups_option_t *options)		/* I - Options */
{
  ...
  printf(("cupsPrintFiles2(http=%p, name=\"%s\", num_files=%d, "
                "files=%p, title=\"%s\", num_options=%d, options=%p)",
    ...
    int        depth)			/* I - Depth of query */
{
  ...
  printf("7cups_get_printer_uri(http=%p, name=\"%s\", host=%p, "
  ...
  */
  ...
  printf("9cups_get_printer_uri: printer-uri=\"%s\"\n", uri);
