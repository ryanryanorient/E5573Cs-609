              ...
              cups_option_t **options)	/* IO - Pointer to options */
{
  ...
  printf("2cupsAddOption(name=\"%s\", value=\"%s\", num_options=%d, "
  ...
  */
  ...
  if (diff)
  {
    ...
    */
    ...
    printf("4cupsAddOption: New option inserted at index %d...",
                  insert);
    ...
    if (temp == NULL)
    {
      printf("3cupsAddOption: Unable to expand option array, returning 0");
      return (0);
    }
  ...
  else
  {
    ...
    */
    ...
    printf("4cupsAddOption: Option already exists at index %d...",
                  insert);
  ...
  printf("3cupsAddOption: Returning %d", num_options);
