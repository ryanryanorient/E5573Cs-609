...
#  endif /* HAVE_POLL */
  ...
  printf("entry httpAddrConnect2(addrlist=%p, sock=%p, msec=%d, cancel=%p)\n",
  ...
  */
  ...
  while (addrlist)
  {
    ...
    */
    ...
    printf("httpAddrConnect2: Setting non-blocking connect()\n");
...
#  endif /* WIN32 */
    {
      printf("1httpAddrConnect2: Finishing async connect()\n");
	...
	do
	    ...
	    */
            ...
            printf("1httpAddrConnect2: Canceled connect()\n");
...
#  ifdef HAVE_POLL
	  ...
	  printf("1httpAddrConnect2: poll() returned %d (%d)\n", nfds,
	                errno);
...
#  else
	  ...
	  printf("1httpAddrConnect2: select() returned %d (%d)\n", nfds,
	                errno);
#  endif /* HAVE_POLL */
	}
#  ifdef WIN32
...
#ifdef DEBUG
  printf("httpAddrGetList(hostname=\"%s\", family=AF_%s, "
                     "service=\"%s\")\n",
