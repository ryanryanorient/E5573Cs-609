...
#define WILDCARD_SSID_SCAN ((struct wpa_ssid *) 1)
	...
	/* BEGIN PN: DTS2012070307199, Modified by l00182072, 2012/7/7*/
	//w00176398 add for setting scan flag
	int scan_flag;
	/* END   PN: DTS2012070307199, Modified by l00182072, 2012/7/7*/

	/*BEGIN PN: DTS2013032100903  2013/05/24  by shenxiong    ADD */
	/* record the channel set for scan */
	struct scan_channel channels;
  /*END PN: DTS2013032100903  2013/05/24  by shenxiong    ADD */
};
