...
/* BEGIN PN: DTS2012081607635,Added  by l00182072, 2012/9/5*/
extern int g_channel_filter;
/* END   PN: DTS2012081607635,Added  by l00182072, 2012/9/5*/
					      ...
					      int own_request)
{
	...
	/* EDD PN: DTS2013061809061 ,Added by s00208871, 2013/7/4 */
					  ...
					  int locally_generated)
{
    ...
    if(wpa_s->wpa_state == WPA_4WAY_HANDSHAKE && wpa_key_mgmt_wpa_psk(wpa_s->key_mgmt)) {
      ...
      if( 1 == g_disassoc_flag || 1 == locally_generated ) {
						 ...
						 int locally_generated)
{
	...
	last_ssid = wpa_s->current_ssid;
 	...
 	/* BEGIN PN: DTS2012062804063, Deleted  by l00182072, 2012/7/10*/
	wpa_supplicant_mark_disassoc(wpa_s);
	/* END   PN: DTS2012062804063, Deleted  by l00182072, 2012/7/10*/
