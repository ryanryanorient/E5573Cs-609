...
/******************************************************************************
修改日期        修改人        问题单号                简要描述
2012/07/04      l00182072     DTS2012041301134        合入v3r2上报错误原因码的处理
...
2014/01/06      s00208871     DTS2013122707692        输入错误密码，概率没有提示重新输入密码的对话框
2014/01/07      s00208871     DTS2014010206112        输入正确密码进行连接，长时间连接后，没有连接成功，弹出密码框要求重新输入密码
2013/01/11      s00208871     DTS2014010807630        Wi-Fi的自動OFF虽然设定到了30分、但是公衆無線LAN的接続持续12分～15分左右就切断了
2014/09/22      y84014385     DTS2014082110507        单板已经连接上行AP成功，再次通过WEBUI手动连接AP时，需要页面上点击两次才能连接成功
******************************************************************************/
#include "includes.h"
...
/* BEGIN PN: DTS2012041301134,Added  by l00182072, 2012/7/4*/
extern WPA_4WAY_HANDSHAKE_FLAG is_wpa_4way_handshake_failed;
/* END   PN: DTS2012041301134,Added  by l00182072, 2012/7/4*/
/* BEGIN PN: DTS2012112401041,Added  by l00182072, 2012/11/27*/
extern WPA_SUPPLICANT_PRIVATE_STATE gWpaSupplicantCurrentState;
/* END   PN: DTS2012112401041,Added  by l00182072, 2012/11/27*/
...
int wpa_supplicant_reload_configuration(struct wpa_supplicant *wpa_s)
{
	...
	/* BEGIN PN: DTS2012111300780, Deleted  by l00182072, 2012/11/9*/
	//eapol_sm_invalidate_cached_session(wpa_s->eapol);
	/* END   PN: DTS2012111300780, Deleted  by l00182072, 2012/11/9*/
				    ...
				    struct wpa_ssid *ssid)
{
	...
	if (ssid == NULL) {
  	...
  	/* BEGIN PN: DTS2012063002727,Modified by l00182072, 2012/7/3*/
  	if (ssid == wpa_s->current_ssid) {
      wpa_printf(MSG_DEBUG, "disable network");
      wpa_supplicant_cancel_auth_timeout(wpa_s);
      //wpa_supplicant_disassociate(wpa_s, WLAN_REASON_DEAUTH_LEAVING);
  	}
  	/* END   PN: DTS2012063002727,Modified by l00182072, 2012/7/3*/
