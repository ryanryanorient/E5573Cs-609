...
/* BEGIN PN: DTS2012063005057,Added  by l00182072, 2012/7/23*/
#define wpa_stacall_cmd_add_len    (20)
#define wpa_stacall_cmd_str_len    (8)
#define wpa_stacall_cmd_add_len1    (20 + 10)
/* END   PN: DTS2012063005057,Added  by l00182072, 2012/7/23*/
					      ...
					      void *sock_ctx)
{
  ...
  /* END   PN: DTS2012063005057,Added  by l00182072, 2012/7/23*/
	...
	/* BEGIN PN: DTS2012063005057, Modified by l00182072, 2012/7/23*/
  ...
  if (0 == os_strncmp(buf, "stacall ", 8)) {
	...
	/* END   PN: DTS2012063005057, Modified by l00182072, 2012/7/23*/
