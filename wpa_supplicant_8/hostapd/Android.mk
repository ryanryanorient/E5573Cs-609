...
L_CFLAGS += -DCONFIG_CTRL_IFACE_CLIENT_DIR=\"/var/run/hostapd\"
...
INCLUDES += $(TARGET_OUT_HEADERS)/netplatform/offload/include
INCLUDES += $(TARGET_OUT_HEADERS)/netplatform/lib/libipc/inc
INCLUDES += $(TARGET_OUT_HEADERS)/netplatform/netplatform/npdaemon/inc
else
INCLUDES += $(LOCAL_PATH)/../../../netplatform/include
INCLUDES += $(LOCAL_PATH)/../../../../include
INCLUDES += $(LOCAL_PATH)/../../../../netplatforminc
INCLUDES += $(LOCAL_PATH)/../../../netplatform/offload/include
INCLUDES += $(LOCAL_PATH)/../../../netplatform/lib/libipc/inc
INCLUDES += $(LOCAL_PATH)/../../../netplatform/netplatform/npdaemon/inc
endif
...
LOCAL_SHARED_LIBRARIES := libc libcutils liblog libpublicapi libipc#libcrypto libssl
ifdef CONFIG_DRIVER_NL80211
