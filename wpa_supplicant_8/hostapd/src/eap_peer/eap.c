...
2012/12/25      l00182072     DTS2012122500375          增加打印log的调试宏和相关代码
2014/02/21      s00208871     DTS2014022104555          添加eap鉴权失败上报原因码
******************************************************************************/
#include "includes.h"
...
/* BEGIN PN: DTS2012112006806,Added  by l00182072, 2012/11/26*/
extern WPA_SUPPLICANT_PRIVATE_STATE gWpaSupplicantCurrentState;
/* END   PN: DTS2012112006806,Added  by l00182072, 2012/11/26*/
...
/* BEGIN PN: DTS2012111300780, Modified by l00182072, 2012/11/9*/
#ifdef PCSC_FUNCS
...
int eap_sm_add_domain_name(u8 *identity, size_t *identity_len)
{
    ...
    /* BEGIN PN: DTS2012122500375, Modified by l00182072, 2012/12/25*/
#ifdef  SUPP_EAP_SIM_TEST    
	wpa_printf(MSG_ERROR, "identity:%s,identity_len=%d \n ",identity, *identity_len);
#endif    
    /* END   PN: DTS2012122500375, Modified by l00182072, 2012/12/25*/
    return  0;
}
/*
...
struct wpabuf * eap_sm_buildIdentity(struct eap_sm *sm, int id, int encrypted)
{
	...
	const u8 *identity;
	size_t identity_len;
    /* BEGIN PN: DTS2012111300780,Added  by l00182072, 2012/11/9*/
    int ret = 0;
    /* END   PN: DTS2012111300780,Added  by l00182072, 2012/11/9*/
